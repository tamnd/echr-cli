...
func TestHostWiring(t *testing.T) {
	...
	if want := "echr://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("echr", "about")
	if err != nil || got.String() != "echr://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want echr://page/about", got.String(), err)
	}
}
