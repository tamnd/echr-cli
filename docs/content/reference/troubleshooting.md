...
Most of these come down to network reality or how echr serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

echr rate-limits like any public site. echr already paces
...
Where a surface is gated, echr reads a cookie or token you supply
...
`echr`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what echr actually did
